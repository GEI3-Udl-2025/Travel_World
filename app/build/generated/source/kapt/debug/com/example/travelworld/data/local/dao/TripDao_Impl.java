...
public final class TripDao_Impl implements TripDao {
  ...
  public TripDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTripEntity = new EntityInsertionAdapter<TripEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `trips` (`id`,`title`,`description`) VALUES (nullif(?, 0),?,?)";
      }
    ...
    this.__updateAdapterOfTripEntity = new EntityDeletionOrUpdateAdapter<TripEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `trips` SET `id` = ?,`title` = ?,`description` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object addTrip(final TripEntity trip, final Continuation<? super Long> $completion) {
  ...
  @Override
  public Object deleteTrip(final int tripId, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object getTrips(final Continuation<? super List<TripEntity>> $completion) {
      ...
      public List<TripEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TripEntity(_tmpId,_tmpTitle,_tmpDescription);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<TripEntity>> getTripsFlow() {
    final String _sql = "SELECT * FROM trips";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
